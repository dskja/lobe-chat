...
export const OFFICIAL_URL = 'https://hadesai-web-app.vercel.app/';
export const OFFICIAL_PREVIEW_URL = 'https://chat-preview.lobehub.com/';
export const OFFICIAL_SITE = 'https://hadesai-web-app.vercel.app/';
...
export const AGENTS_INDEX_GITHUB = 'https://github.com/hadesai-web-app/lobe-chat-agents';
...
export const EMAIL_SUPPORT = 'VaultVerse@proton.me';
export const EMAIL_BUSINESS = 'VaultVerse@proton.me';
